...
insert into testTBL1 (id, userName) values (2, '박효진');
insert into testTBL1 (id) values (3, '이수영'); -- 에러
insert into testTBL1 (id, userName) values (3, '이수영');
insert into testTBL1 (age, id) values (30,4);
insert into testTBL1 (userName, age) values ('설현',23); -- pk 에러 
...
update testTBL1
	...
	delete from testTBL1 where id=8;
